...
public class GameView extends View {
    ...
    public GameView(Context context, @Nullable AttributeSet attrs) { super(context, attrs); }
    ...
    public void setGameScoreUpdatedListener(ScoreUpdateListener scoreUpdatedListener) {
    ...
    private Point getPoint(int x, int y) { return mPoints[y][x]; }
    ...
    public boolean ismGameOver() { return mGameOver; }
